...
#
#  $ bin/test -s shop.bundled -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src shop.bundled.testing.SHOP_BUNDLED_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/shop/bundled/tests/robot/test_example.robot
#
